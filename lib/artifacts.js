...
// 素材库资产的图像存储命名空间。与 variant:/canvas: 同居 aicrew_assets，
// 故必须独立前缀，避免库素材与变体封面在 LRU 修剪 / 回填时互相串键。
export function libraryAssetRefKey(assetId) {
  return `library:${String(assetId || "unknown")}`;
}
