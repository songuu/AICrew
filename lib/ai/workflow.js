...
function renderTrendGuidance(brief, skill) {
...
function renderPersonaGuidance(brief, skill) {
...
function renderSeoGuidance(brief, skill) {
...
function buildCopyPrompt(brief, variant, brandKit, preset, skill) {
  return [
    ...
    renderTrendGuidance(brief, skill),
    renderHookGuidance(brief, preset, skill),
    renderAngleFramework(variant),
    renderPersonaGuidance(brief, skill),
    renderCopyRules(preset),
    renderSeoGuidance(brief, skill),
