...
const OMIT_FROM_PAYLOAD = new Set([...COLLECTION_KEYS, ...SERVER_OWNED_STATE_KEYS, "brandKit", "creditSystemWallet"]);
...
function creditWalletFromPayload(workspaceId, workspaceRow = {}, payload = {}) {
  ...
  return wallet.buckets.length === 0 && wallet.availableCredits > 0
    ? createSeededCreditSystemWallet({
        ...wallet,
